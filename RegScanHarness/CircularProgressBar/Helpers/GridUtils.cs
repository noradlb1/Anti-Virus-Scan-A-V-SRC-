    ...
    public class GridUtils
    {
        ...
        private static GridLength ParseLength(string length)
        {
            ...
            else if (length.Contains("*"))
            {
                ...
                return new GridLength(double.Parse(length, NumberFormatInfo.InvariantInfo), GridUnitType.Star);
            }

            return new GridLength(double.Parse(length, NumberFormatInfo.InvariantInfo), GridUnitType.Pixel);
        }
    }
}
